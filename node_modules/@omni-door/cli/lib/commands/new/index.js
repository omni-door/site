        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 3:
                    ...
                    _b = template, root = _b.root, test = _b.test, _c = _b.typescript, typescript = _c === void 0 ? false : _c, _d = _b.stylesheet, stylesheet = _d === void 0 ? '' : _d, _e = _b.readme, readme = _e === void 0 ? false : _e;
                    module_cn = '组件';
                    module_en = 'component';
                    if (type === 'toolkit') {
                        module_cn = '模块';
                    ...
                    questions_1 = [
                        {
                            ...
                            message: utils_2.logo() + " Please enter " + module_en + " name(\u8BF7\u8F93\u5165" + module_cn + "\u540D\u79F0):"
                        },
                        {
                            name: 'type',
                            type: 'list',
                            ...
                            message: utils_2.logo() + " Select the type of " + module_en + "(\u9009\u62E9" + module_cn + "\u7C7B\u578B):"
                        }
                    ];
                ...
                case 7:
                    ...
                    utils_1.logInfo("Downloading the " + newTpl + ", please wait patiently(\u6B63\u5728\u4E0B\u8F7D " + newTpl + "\uFF0C\u8BF7\u7A0D\u540E)\u2026");
                    utils_1.exec([
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 6:
                                        _c;
                                        // success logger
                                        utils_1.logSuc("The " + componentName + " local at " + path_cp_rel + ", construction completed(" + componentName + " \u4F4D\u4E8E " + path_cp_rel + "\uFF0C\u521B\u5EFA\u5B8C\u6210)!");
                                        process.exit(0);
                                        return [2 /*return*/];
                                }
                            });
                        ...
                        utils_1.logErr(err);
                        utils_1.logErr('👆 Oops! Some error occured(完蛋！好像有错误)\n');
                        process.exit(1);
                    });
                    return [2 /*return*/];
            }
