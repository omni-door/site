...
function default_1(strategy, _a, option) {
    var react_basic = _a.react_basic, react_standard = _a.react_standard, react_entire = _a.react_entire, vue_basic = _a.vue_basic, vue_standard = _a.vue_standard, vue_entire = _a.vue_entire, react_ssr = _a.react_ssr, react_components = _a.react_components, vue_components = _a.vue_components, toolkit = _a.toolkit, install = _a.install;
    return __awaiter(this, void 0, void 0, function () {
                ...
                case 8:
                        ...
                        dupDirQuestions.push.apply(dupDirQuestions, [{
                                ...
                                message: function (answer) {
                                    return __awaiter(this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            name = answer.name;
                                            return [2 /*return*/, utils_2.logo() + "[" + currStep_1 + "/" + totalStep_1 + "] Are you sure to overwrite the \"" + name + "\" directory(\u786E\u5B9A\u8981\u8986\u76D6\u5DF2\u7ECF\u5B58\u5728\u7684 \"" + name + "\" \u6587\u4EF6\u5939)?"];
                                        });
                                    });
                                },
                                ...
                                type: 'input',
                                message: function (answer) {
                                    return utils_2.logo() + "[" + currStep_1 + "/" + totalStep_1 + "] Please reenter your project name(\u8BF7\u91CD\u65B0\u8F93\u5165\u9879\u76EE\u540D\u79F0):";
                                },
                                when: function (answer) {
                                    return __awaiter(this, void 0, void 0, function () {
                                        var name, _a, _b;
                    ...
                    questions_1 = __spreadArrays([
                    ...
                    ], dupDirQuestions, [
                        {
                                ...
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            ...
                                            case 2:
                                                if (_a) {
                                                    utils_1.logWarn('Please turn over to think then try again');
                                                    utils_1.logWarn('失败次数太多，请想清楚后再试');
                            ...
                            default: function (answer) { return getProjectType_1(answer) !== 'spa-react' && getProjectType_1(answer) !== 'spa-vue' && getProjectType_1(answer) !== 'ssr-react'; },
                            when: function (answer) {
                                var projectType = getProjectType_1(answer);
                                if (projectType === 'spa-react' || projectType === 'spa-vue' || projectType === 'ssr-react') {
                                    return true;
