...
exports.tryGitInit = exports.isInGitRepository = void 0;
...
function tryGitInit() {
    try {
        child_process_1.execSync('git --version', { stdio: 'ignore' });
        ...
        logger_1.logWarn(e);
        logger_1.logWarn('Git-repo init failed');
        logger_1.logWarn('Git仓库初始化失败');
        return false;
    }
}
