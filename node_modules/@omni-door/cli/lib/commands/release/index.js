            ...
            switch (_s.label) {
                ...
                case 3:
                    if (!config || JSON.stringify(config) === '{}') {
                        utils_1.logWarn('请先初始化项目！(Please initialize project first!)');
                        process.exit(0);
                    }
                    // bind exit signals
                    utils_2.signal();
                            ...
                            inquirer_1.default.prompt([
                                {
                                    ...
                                    message: utils_2.logo() + "\u8BF7\u9009\u62E9\u8FED\u4EE3\u7B56\u7565 (Please choice iteration strategy)\uFF1A"
                                },
                                {
                                    name: 'version',
                                    type: 'input',
                                    ...
                                    message: utils_2.logo() + "\u8BF7\u8F93\u5165\u8FED\u4EE3\u7684\u7248\u672C\u53F7 (Please input the iteration version):"
                                },
                                {
                                    name: 'label',
                                    type: 'input',
                                    ...
                                    message: utils_2.logo() + "\u8BF7\u8F93\u5165\u8FED\u4EE3\u7684\u6807\u7B7E (Please input the iteration tag):"
                                }
                            ])
                                .then(function (answers) {
                                var _a, _b;
                                var iter = answers.iter, version = answers.version, label = answers.label;
                                if (label) {
                                    tag_1 = label;
                                }
                                else if (autoTag && npm) {
                                    tag_1 = version
                                        ? (_b = (_a = version.match(/[a-zA-Z]+/g)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 'latest' : defaultTag_1;
                                }
                                switch (iter) {
                ...
                case 7:
                    ...
                    utils_1.logInfo('开始自动构建项目！(Start building the project automatically!)');
                    _s.label = 8;
                case 8:
                ...
                case 10:
                    ...
                    return [3 /*break*/, 11];
                case 11:
                    utils_1.logTime('项目发布');
                    utils_1.logInfo('开始发布！(Starting release process!)');
                    if (!(!autoBuild && verify && test)) return [3 /*break*/, 13];
                    return [4 /*yield*/, utils_1.exec(['npm test'], function () { return utils_1.logEmph(utils_1.italic('单元测试通过！(The unit test passed!)')); }, handleReleaseErr('单元测试失败！(The unit test failed!)'))];
                case 12:
                    _s.sent();
                    _s.label = 13;
                case 13:
                    if (!(!autoBuild && verify && eslint)) return [3 /*break*/, 15];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:es'], function () { return utils_1.logEmph(utils_1.italic('eslint校验通过！(The eslint passed!)')); }, handleReleaseErr("eslint\u6821\u9A8C\u5931\u8D25\uFF01(The eslint checking failed!) \n \u5C1D\u8BD5\u6267\u884C (try to exec): " + utils_1.underline('npm run lint:es_fix')))];
                case 14:
                    _s.sent();
                    _s.label = 15;
                case 15:
                    if (!(!autoBuild && verify && prettier)) return [3 /*break*/, 17];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:prettier'], function () { return utils_1.logEmph(utils_1.italic('prettier校验通过！(The prettier passed!)')); }, handleReleaseErr("prettier\u6821\u9A8C\u5931\u8D25\uFF01(The prettier checking failed!) \n \u5C1D\u8BD5\u6267\u884C (try to exec): " + utils_1.underline('npm run lint:prettier_fix')))];
                case 16:
                    _s.sent();
                    _s.label = 17;
                case 17:
                    if (!(!autoBuild && verify && stylelint)) return [3 /*break*/, 19];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:style'], function () { return utils_1.logEmph(utils_1.italic('stylelint校验通过！(The stylelint passed!)')); }, handleReleaseErr("stylelint\u6821\u9A8C\u5931\u8D25\uFF01(The stylelint checking failed!) \n \u5C1D\u8BD5\u6267\u884C (try to exec): " + utils_1.underline('npm run lint:style_fix')))];
                case 18:
                    _s.sent();
                    _s.label = 19;
                case 19:
                    versionShellSuffix = ignore_1 ? 'i' : manual_1 ? manual_1 : '';
                    return [4 /*yield*/, utils_1.exec([path_1.default.resolve(__dirname, 'version.sh') + " \"" + utils_1.logPrefix() + "\" " + versionShellSuffix], function () {
                            ...
                            pkj_1 = getPkjData(pkjPath_1);
                            utils_1.logEmph("\u5F53\u524D\u7248\u672C\u53F7\u4E3A " + pkj_1.version + "\uFF01(The current version is " + pkj_1.version + "!)");
                ...
                case 22:
                    ...
                    !gitOmniUrl_1 && utils_1.logInfo("\u65B0\u589E\u8FDC\u7A0B\u5730\u5740omni " + git + " (Adding remote omni " + git + ")");
                    ...
                    return [4 /*yield*/, utils_1.exec(execArr, function () {
                            utils_1.logEmph("git remote omni \u4E3A " + git + " (git remote omni is: " + git + ")");
                            remote_1 = 'omni';
                        }, function () {
                            utils_1.logWarn('git remote 设置失败！(setting git remote failed!)');
                            canPush_1 = false;
                        })];
                case 23:
                    _s.sent();
                ...
                case 24:
                    ...
                    return [4 /*yield*/, utils_1.exec([
                            ...
                            "" + commit,
                            "" + push
                        ], function () { return utils_1.logEmph('git仓库推送成功！(Pushing to git-repo success!)'); }, handleReleaseErr('git仓库推送失败！(Pushing to git-repo failed!)'))];
                case 25:
                    _p = (_s.sent());
                    _s.label = 26;
                case 26:
                ...
                case 28:
                    _s.sent();
                    return [4 /*yield*/, utils_1.exec(["npm publish --registry=" + (npm || npmUrl_1) + " --tag=" + tag_1], function () { return utils_1.logEmph("npm\u5305\u53D1\u5E03\u6210\u529F, \u7248\u672C\u53F7\u4E3A " + pkj_1.version + "@" + tag_1 + "\uFF01(The npm-package publish success with version " + pkj_1.version + "@" + tag_1 + "!)"); }, handleReleaseErr('npm包发布失败！(The npm-package publish failed!)'))];
                case 29:
                    _s.sent();
                    _s.label = 30;
                case 30:
