...
function server(_a) {
    var p = _a.p, host = _a.host, httpsConfig = _a.https, CA = _a.CA, serverType = _a.serverType, projectType = _a.projectType, _b = _a.devMiddlewareOptions, devMiddlewareOptions = _b === void 0 ? {} : _b, webpackConfig = _a.webpackConfig, _c = _a.proxyConfig, proxyConfig = _c === void 0 ? [] : _c, _d = _a.middlewareConfig, middlewareConfig = _d === void 0 ? [] : _d, nextRouter = _a.nextRouter, favicon = _a.favicon;
    return __awaiter(this, void 0, void 0, function () {
        var CWD, ip, ipAddress, serverHost, openHost, serverUrl_1, ServerDevCli, autoOpenServer, needCustomServer, isHttps, key, cert, cacheDirPath, keyPath, certPath, ca, certificate, err_1, serverBasicOptions, delay, err_2;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    ServerDevCli = {
                        storybook: path_1.default.resolve(CWD, 'node_modules/.bin/start-storybook') + " -p " + p + " -h " + serverHost + " --quiet",
                ...
                case 9:
                    if (isHttps && (!key || !cert)) {
                        utils_1.logWarn('证书缺失，将以http启动开发服务！(Missing the certificate, start the dev-server with http!)');
                        isHttps = false;
                    }
                    serverBasicOptions = {
                    ...
                    switch (projectType) {
                        case 'ssr-react':
                            servers_1.KNServer(__assign({ dev: process.env.NODE_ENV === 'production' ? false : true, nextRouter: nextRouter }, serverBasicOptions));
                            break;
                        case 'ssr-vue':
                ...
                case 10:
                    ...
                    if (~autoOpenServer.indexOf(serverType))
                        setTimeout(function () { return open_1.default(serverUrl_1); }, delay);
                    _e.label = 11;
