...
export default function (strategy: STRATEGY, { react_basic, react_standard, react_entire, vue_basic, vue_standard, vue_entire, react_ssr, react_components, toolkit, install }: OptionType, option?: OptionCustom): Promise<void>;
export {};
