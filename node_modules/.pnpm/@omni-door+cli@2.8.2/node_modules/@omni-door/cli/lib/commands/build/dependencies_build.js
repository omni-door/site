...
function default_1(config) {
    return __awaiter(this, void 0, void 0, function () {
        var dependency, build, project_type, buildDependencies;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utils_1.getDependency('stable', {
                        '@babel/core': '~7.10.0',
                ...
                case 1:
                    dependency = _a.sent();
                    build = config.build, project_type = config.project_type;
                    buildDependencies = build === 'webpack' ? [
                        dependency('webpack'),
                        ...
                        : [];
                    return [2 /*return*/, utils_1.arr2str(buildDependencies)];
            }
        });
    });
}
