    ...
    return __awaiter(this, void 0, void 0, function () {
        function getConfig() {
            ...
            try {
                ...
                config = utils_1.requireCwd(configFilePath, isSlient);
            }
            catch (e) {
                utils_1.logWarn(e);
            }
        ...
        function checkConfig() {
            if (!config) {
                utils_1.logWarn("\u8BF7\u5148\u521D\u59CB\u5316\u9879\u76EE\u6216\u68C0\u67E5\u300C" + configFilePath + "\u300D\u914D\u7F6E\u6587\u4EF6\u662F\u5426\u5B58\u5728\u95EE\u9898\uFF01(Please initialize project first or checking is there a problem with the\u300C" + configFilePath + "\u300Dconfig file!)");
                process.exit(0);
            }
        }
        function changeCWD(workPath) {
            try {
                ...
                var cwd = process.cwd();
                utils_1.logEmph("\u5DE5\u4F5C\u8DEF\u5F84\u66F4\u65B0\u4E3A\u300C" + cwd + "\u300D(The work path change to \u300C" + cwd + "\u300D)");
            }
            catch (err) {
                utils_1.logWarn("\u5DE5\u4F5C\u8DEF\u5F84\u66F4\u65B0\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u300C" + workPath + "\u300D\u662F\u5426\u5B58\u5728\uFF01(Please checking the\u300C" + workPath + "\u300Dhad existed!)");
                process.exit(0);
            }
        }
        var e_1, isSlient, args, _a, initial, dev, start, newTpl, build, release, pkj, config, configFilePath;
