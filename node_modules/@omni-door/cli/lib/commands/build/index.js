                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, utils_1.exec([
                                    ...
                                    utils_1.logEmph('The dependencies install completed');
                                    utils_1.logEmph('构建依赖安装完毕');
                                    return true;
                                }, function (err) {
                                    utils_1.logWarn(err);
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, utils_1.exec(['npm test'], function () { return utils_1.logEmph(utils_1.italic('Unit Test!')); }, handleBuildErr('The unit test not pass(单元测试失败)'))];
                case 5:
                    _k.sent();
                    _k.label = 6;
                case 6:
                    if (!(verify && eslint)) return [3 /*break*/, 8];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:es'], function () { return utils_1.logEmph(utils_1.italic('Eslint!')); }, handleBuildErr("The eslint not pass(eslint\u6821\u9A8C\u5931\u8D25) \n try to exec(\u5C1D\u8BD5\u6267\u884C): " + utils_1.underline('npm run lint:es_fix')))];
                case 7:
                    _k.sent();
                    _k.label = 8;
                case 8:
                    if (!(verify && prettier)) return [3 /*break*/, 10];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:prettier'], function () { return utils_1.logEmph(utils_1.italic('Prettier!')); }, handleBuildErr("The prettier not pass(prettier\u6821\u9A8C\u5931\u8D25) \n try to exec(\u5C1D\u8BD5\u6267\u884C): " + utils_1.underline('npm run lint:prettier_fix')))];
                case 9:
                    _k.sent();
                    _k.label = 10;
                case 10:
                    if (!(verify && stylelint)) return [3 /*break*/, 12];
                    return [4 /*yield*/, utils_1.exec(['npm run lint:style'], function () { return utils_1.logEmph(utils_1.italic('Stylelint!')); }, handleBuildErr("The stylelint not pass(stylelint\u6821\u9A8C\u5931\u8D25) \n try to exec(\u5C1D\u8BD5\u6267\u884C): " + utils_1.underline('npm run lint:style_fix')))];
                case 11:
                    _k.sent();
                    _k.label = 12;
                case 12:
                ...
                case 18:
                    ...
                    content_gulp = !buildConfig && (type === 'component-react' || type === 'component-vue') && gulp_1.default({ srcDir: srcDir, outDir: outDir, esmDir: esmDir });
                ...
                case 31:
                    ...
                    utils_1.logInfo('Start auto release');
                    utils_1.logInfo('开始自动发布');
                    _k.label = 32;
                case 32:
