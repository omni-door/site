...
function default_1(_a) {
    var _this = this;
    var dev = _a.dev, ipAddress = _a.ipAddress, _b = _a.proxyConfig, proxyConfig = _b === void 0 ? [] : _b, _c = _a.middlewareConfig, middlewareConfig = _c === void 0 ? [] : _c, host = _a.host, listenHost = _a.listenHost, port = _a.port, httpsConfig = _a.httpsConfig, nextRouter = _a.nextRouter;
    ...
    nextApp
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(pathToRegexp(route).test(path) ||
                            new RegExp("^" + route).test(path))) return [3 /*break*/, 6];
                        needProxy = true;
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
        ...
        // middleware: custom
        app.use(function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
            var path, isMatch, i, item, _a, route, callback, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        path = ctx.path;
                        ...
                        _b.label = 1;
                    case 1:
                        if (!(i < middlewareConfig.length)) return [3 /*break*/, 7];
                        item = middlewareConfig[i];
                        _a = typeof item === 'function' ? item({
                            ip: ipAddress,
                            port: port,
                            host: host,
                            proxyConfig: proxyConfig
                        }) : item, route = _a.route, callback = _a.callback;
                        if (!(pathToRegexp(route).test(path) ||
                            new RegExp("^" + route).test(path))) return [3 /*break*/, 6];
                        isMatch = true;
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, callback(ctx, next)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        ...
                        utils_1.logWarn("The middleware\u300C" + route + ")\u300Dmatch occur error");
                        utils_1.logWarn("\u4E2D\u95F4\u4EF6\u300C" + route + "\u300D\u5339\u914D\u5F02\u5E38");
                        return [3 /*break*/, 5];
                    case 5: return [3 /*break*/, 7];
                    case 6:
                        i++;
        ...
        nextRouter && (nextRouter === null || nextRouter === void 0 ? void 0 : nextRouter.forEachPattern(function (_a) {
            ...
            return router.get(pattern, function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
                var shouldRender, req, res, query, params, err_3, err_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 6:
                            err_4 = _a.sent();
                            shouldRender = false;
                            utils_1.logWarn(JSON.stringify(err_4));
