...
import { logDetail, logEmph, logErr, logInfo, logSuc, logWarn, logTime, underline, italic } from './logger';
...
export { logDetail, logEmph, logErr, logInfo, logSuc, logWarn, logTime, underline, italic } from './logger';
